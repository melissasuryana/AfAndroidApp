...
public abstract class TabHelper {
    ...
    protected TabHelper(SherlockFragmentActivity activity) {
        mActivity = activity;
    }
     ...
     */
    public static TabHelper createInstance(SherlockFragmentActivity activity) {
    ...
    public abstract void addTab(CompatTab tab, int position, boolean setSelected);
