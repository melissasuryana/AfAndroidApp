...
public class TabHelperHoneycomb extends TabHelper {
    ...
    protected TabHelperHoneycomb(SherlockFragmentActivity activity) {
        super(activity);
    }
    ...
    @Override
    public void addTab(CompatTab tab, int position, boolean setSelected) {
        String tag = tab.getTag();
        ...
        // We know tab is a CompatTabHoneycomb instance, so its
        // native tab object is an ActionBar.Tab.
        mActionBar.addTab((ActionBar.Tab) tab.getTab(), position, setSelected);
    }
